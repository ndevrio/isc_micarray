...
# ACDS 19.1 670 linux 2019.11.27.15:21:31
...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/tejas/intelFPGA_lite/19.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/cadence/auk_dspip_avalon_streaming_small_fifo.vhd" -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/cadence/auk_dspip_avalon_streaming_controller.vhd" -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/cadence/auk_dspip_avalon_streaming_sink.vhd"       -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/cadence/auk_dspip_avalon_streaming_source.vhd"     -work work -cdslib ./cds_libs/work.cds.lib
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/cadence/alt_dsp_cic_common_pkg.sv"                 -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/cadence/auk_dspip_cic_lib_pkg.vhd"                 -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/cadence/auk_dspip_differentiator.vhd"              -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/cadence/auk_dspip_downsample.sv"                   -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/cadence/auk_dspip_integrator.vhd"                  -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/cadence/auk_dspip_upsample.vhd"                    -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/cadence/auk_dspip_channel_buffer.vhd"              -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/cadence/auk_dspip_variable_downsample.sv"          -work work -cdslib ./cds_libs/work.cds.lib
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/cadence/alt_cic_int_siso.sv"                       -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/cadence/alt_cic_dec_siso.sv"                       -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/cadence/alt_cic_int_simo.sv"                       -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/cadence/alt_cic_dec_miso.sv"                       -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/cadence/alt_cic_core.sv"                           -work work -cdslib ./cds_libs/work.cds.lib
