...
{
    if (nrhs < 12) {
        mexErrMsgIdAndTxt("Altera:CIC:InputArgs", "Missing arguments.\nUsage: cic(filter_type{'i','d'}, N, M, R_max, R_min, is_size, cs_size, B_in, B_out, rounding_type{'TRUNCATE','CONV_ROUND','ROUND_UP','SATURATE','H_PRUNE'}, operation{'LOAD'}, input_file)");
    }
